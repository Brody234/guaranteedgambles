...
return(
    <div className="main-container">
        <button className="primary-button" onClick = {()=>{router.back()}}><p>Go Back</p></button>
            ...
            <p >
                <span >Welcome to the Partner Program of Guaranteed Gambles, operated by Gamer Coach LLC. By joining our program and promoting our products/services, you agree to abide by the following terms and conditions. Please read them carefully.</span>
            </p>
            <h2  id="h.s7avgy9e48m7">
                <span >Commission Structure</span>
            </h2>
            <p >
                <span >As an partner, you will earn a commission based on a percentage of the sales generated through your unique partner link. The commission rate is specified at the time of your registration. For example, if your commission rate is 50%, you will receive 50% of the total sales amount from customers referred by you.</span>
            </p>
            ...
            <p >
                <span >There is a 30-day wait period for sales to be approved. After this period, you can request a payout to your PayPal account. You may request other forms of payout; however, depending on the form you request, we may ask you to find another form. This wait period is set up to give us time to avoid charge backs and scams.</span>
            </p>
            ...
            <p >
                <span >
                    Thank you for being a part of our partner program.
                </span>
            </p>
            <p >
                <span >
